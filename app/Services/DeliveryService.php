...
class DeliveryService
{
    ...
    public const FRESH_SLOTS = [
        'sang' => ['label' => 'Sáng (7h – 10h)', 'start' => 7, 'end' => 10],
        'trua' => ['label' => 'Trưa (10h – 13h)', 'start' => 10, 'end' => 13],
        'chieu' => ['label' => 'Chiều (13h – 17h)', 'start' => 13, 'end' => 17],
        'toi' => ['label' => 'Tối (17h – 20h)', 'start' => 17, 'end' => 20],
    ];

    /** Giữ map cũ để hiển thị đơn đã lưu trước khi đổi quy trình. */
