        ...
        <div class="card-body py-2">
            <form method="GET" action="{{ route('admin.dashboard') }}" class="row g-2 align-items-end">
                <div class="col-auto">
                    ...
                    <input type="text" id="picker-from" name="from" class="form-control form-control-sm" style="width:130px"
                        placeholder="dd/mm/yyyy" value="{{ $from ?? '' }}" required>
                </div>
                <div class="col-auto">
                    <label class="form-label small mb-0">Đến ngày</label>
                    <input type="text" id="picker-to" name="to" class="form-control form-control-sm" style="width:130px"
                        placeholder="dd/mm/yyyy" value="{{ $to ?? '' }}" required>
                </div>
                <div class="col-auto">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-sm table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-muted p-3">Chưa có dữ liệu bán hàng trong khoảng này.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-muted p-3">Chưa có đơn.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
