            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-8">{{ $order->shipping_name }} - {{ $order->shipping_phone }} -
                            {{ $order->shipping_email }}</div>
                    </div>
                    <div class="row mb-2">
                    ...
                    @if($order->coupon_code)
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-8">{{ $order->coupon_code }}
                                (−{{ number_format((float) $order->discount_amount, 0, ',', '.') }}₫)</div>
                        </div>
                    @endif
                    <div class="row mb-2">
