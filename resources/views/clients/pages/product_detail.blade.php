                    ...
                    <div class="product__details__tab">
                        ...
                        <div class="tab-content">
                                ...
                                <div class="product__details__tab__desc">
                                    @if ($product->description)
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <span class="d-block mt-1">- Bảo quản lạnh: Giữ trong ngăn mát tủ lạnh, nhiệt độ phù hợp để làm chậm quá trình hư hỏng.</span>
                                            <span class="d-block mt-1">- Đóng gói kín: Sử dụng túi/hộp đựng sạch, kín để hạn chế mất nước, nhiễm mùi và nhiễm khuẩn.</span>
                                            <span class="d-block mt-1">- Giữ vệ sinh: Không để thực phẩm tiếp xúc với thực phẩm sống khác hoặc bề mặt bẩn.</span>
                                            <span class="d-block mt-1">- Không để quá lâu: Ưu tiên sử dụng thực phẩm sớm và kiểm tra tình trạng trước khi sử dụng.</span>
                                        </div>
                                    @else
                            ...
                            <div class="tab-pane" id="tabs-2" role="tabpanel">
                                <div class="product__details__tab__desc">
                                    <h4 >Khách hàng nhận xét ({{ $reviewCount }})</h4>
