...
// admin/login → chuyển về form đăng nhập chung
...
Route::middleware(['admin'])->group(function () {
    ...
    Route::middleware('permission:module:products')->group(function () {
    ...
    Route::middleware('permission:module:categories')->group(function () {
        Route::resource('categories', AdminCategoryController::class)
            ->except(['show'])
            ->names('admin.categories');
    });

    Route::middleware(('permission:module:recipes'))->group(function () {
    ...
    Route::middleware('permission:module:coupons')->group(function () {
        Route::resource('coupons', AdminCouponController::class)
            ->except(['show'])
            ->names('admin.coupons');
    });

    Route::middleware('permission:module:reviews')->group(function () {
